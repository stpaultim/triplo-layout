...
/**
 * @file
 * Template for the Triplo layout.
 *
 * Variables:
 ...
 */
?>
<div class="layout--triplo <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
    <a href="#main-content" class="element-invisible element-focusable"><?php print t('Skip to main content'); ?></a>
  </div>

    <div class="l-header l-halves row">
        <div class="l-header-halves-region col-md-6">
          <?php print $content['header_half1']; ?>
        </div>
        <div class="l-headerhalves-region col-md-6">
          <?php print $content['header_half2']; ?>
        </div>
    </div><!-- /.l-middle -->
